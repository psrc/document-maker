...
data_21<-data_21%>%drop_na(c('gender', 'travelers_total_grp'))
  ...
  summs_2017_2019 <- hhts_count(data_17_19,
                                        ...
                                        spec_wgt='trip_adult_weight_2017_2019')%>%drop_na(c('gender', 'travelers_total_grp'))%>%filter(travelers_total_grp!='Total')%>%filter(gender %in% c('Female', 'Male') )

  summs_2021 <- hhts_count(data_21,
                                   group_vars=c('gender','travelers_total_grp'),
                                   spec_wgt='trip_adult_weight_2021') %>%drop_na(c('gender', 'travelers_total_grp'))%>%filter(travelers_total_grp!='Total')%>%filter(gender %in% c('Female', 'Male') )
