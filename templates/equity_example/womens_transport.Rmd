...
```{r}
  ...
  summs_2017_2019 <- hhts_count(data_17_19,
                                        ...
                                        spec_wgt='trip_adult_weight_2017_2019')%>%drop_na(c('gender', 'simple_purpose'))%>%filter(simple_purpose!='Total')

  summs_2021 <- hhts_count(data_21,
                                   group_vars=c('gender','simple_purpose'),
                                   spec_wgt='trip_adult_weight_2021') %>%drop_na(c('gender', 'simple_purpose'))%>%filter(simple_purpose!='Total')
...
```{r}
 trips_persons_2017_2019<- merge(summs_2017_2019, person_summs_2017_2019, by='gender', suffixes=c('_trips','_people' ))%>%filter(gender %in% c('Female', 'Male') )
 trips_persons_2021<- merge(summs_2021, person_summs_2021, by='gender', suffixes=c('_trips','_people' ))
 ...
 trips_persons_long<- rbind(trips_persons_2017_2019, trips_persons_2021) %>%
    mutate(survey_trips = str_replace_all(survey_trips, "_", "/"))%>%filter(gender %in% c('Female', 'Male') )
...
show this as % of trips for not work and school
```{r}
...
```{r}
  ...
  summs_2017_2019 <- hhts_count(data_17_19,
                                        ...
                                        spec_wgt='trip_adult_weight_2017_2019')%>%drop_na(c('gender', 'mode_simple'))%>%filter(mode_simple!='Total')

  summs_2021 <- hhts_count(data_21,
                                   group_vars=c('gender','mode_simple'),
                                   spec_wgt='trip_adult_weight_2021') %>%drop_na(c('gender', 'mode_simple'))%>%filter(mode_simple!='Total')
...
data_21<-data_21%>%drop_na(c('gender', 'travelers_total_grp'))
  ...
  summs_2017_2019 <- hhts_count(data_17_19,
                                        ...
                                        spec_wgt='trip_adult_weight_2017_2019')%>%drop_na(c('gender', 'travelers_total_grp'))%>%filter(travelers_total_grp!='Total')%>%filter(gender %in% c('Female', 'Male') )%>%filter(travelers_total_grp!='1')

  summs_2021 <- hhts_count(data_21,
                                   group_vars=c('gender','travelers_total_grp'),
                                   spec_wgt='trip_adult_weight_2021') %>%drop_na(c('gender', 'travelers_total_grp'))%>%filter(travelers_total_grp!='Total')%>%filter(gender %in% c('Female', 'Male') )%>%filter(travelers_total_grp!='1')
