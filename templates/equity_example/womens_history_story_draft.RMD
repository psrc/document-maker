...
distance <- static_column_chart(t= summs_2017_2019_dist, 
                                ...
                                color = "psrc_pairs",
                                est='number', 
                                title='Figure 4. 2017/2019 Trip Distance by Gender')
...
```{r matrix, fig.height = 2.3, fig.width = 4, fig.subcap=c('by Gender', 'by Race and Gender'), out.height = "80%", echo = FALSE}
...
#### While we are working towards a more non-binary understand of gendered data, we acknowledge that much of the data presented above does analyze information and patterns in a binary manner. 