...
### Transit isn't Always Efficient for Women
...
```{r matrix, fig.height = 2.3, fig.width = 4, fig.subcap=c('by Gender', 'by Trip Distance', 'by Race and Gender'), fig.ncol = 2, out.width = "50%", fig.pos= "H", echo = FALSE}
