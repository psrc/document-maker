...
.libPaths("C:/Users/MGrzybowski/AppData/Local/R/win-library/4.2")
...
#output_dir<-file.path(getwd(), 'equity_example')
...
output_path <- "C:/Coding/CURRENT_REPOS_GITHUB/document-maker/templates/equity_example"
...
image5<-  image_read(file.path(network_file_loc, "women2.jpg"))
...
women_image_header
```
![](C:/Coding/CURRENT_REPOS_GITHUB/document-maker/templates/equity_example/women_image_header.png){width=100%}
