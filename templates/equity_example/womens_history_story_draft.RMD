...
race_aggregated_21 <- static_bar_chart(t=inc_sex_2021_poc, 
                                    ...
                                    color="psrc_pairs",
                                    est ="currency",
                                    title = "2021 Income by Gender and by Race")
```

```{r plots for rig, fig.height = 2.3, fig.width = 4, fig.subcap=c('by Gender', 'by Race and Gender'), fig.ncol = 2, out.width = "50%", out.height="80%",fig.pos = "H", echo = FALSE}
