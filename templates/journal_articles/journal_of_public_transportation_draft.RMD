---
title: 'Women and their Unique Travel Needs '
author: "Suzanne Childress, Christy Lam, Mary Richards, Joanne Lin, Meg Grzybowski"
...
# Title of Article Women's Diverse Travel Needs Often Go Overlooked
\onehalfspacing
...
#tinytex::reinstall_tinytex() #if using too old of a version
...
source('womens_history_story_draft_datacrunching.R')
```
...
{\underline{\textbf{Keywords}}} Women and transportation, Transit disparities, Household travel survey, Impacts of telecommuting, Puget Sound Regional Council, Equity access to safe transportation modalities

{\underline{\textbf{Abstract}}}

{\underline{\textbf{Acknowledgements}}} These authors acknowledge the Puget Sound Regional Council and the efforts contributed to the Household Travel Survey from which this case study is drawn from. Additionally, without the contributions of \textbf{the Data Science Team, Modeling, and Applications Teams}, this work would not have been achievable. 
...
```{r Age group by gender, fig.dim=c(5,4), echo = FALSE, eval = FALSE}
